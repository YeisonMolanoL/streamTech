...
import { NbActionsModule, NbAlertModule, NbAutocompleteModule, NbBadgeModule, NbButtonModule, NbContextMenuModule, NbIconModule, NbInputModule, NbLayoutModule, NbMenuModule, NbSearchModule, NbSelectModule, NbSidebarModule, NbSpinnerModule, NbTagModule, NbThemeModule, NbTooltipModule, NbUserModule } from '@nebular/theme';
...
@NgModule({
  declarations: [PagesComponent, HeaderComponent, PlattformsComponent, CardInfoComponent,
    AccountComponent, SellByProfileComponent, SellByAccountComponent, YesNoPipelinePipe, AccountListComponent, SellByComboComponent
  ],
  imports: [
    CommonModule,
    PagesRoutingModule,
